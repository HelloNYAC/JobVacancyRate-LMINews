...
$(function () {
  ...
  getNews(paramStr, function (res) {
    ...
    if (data && data.length > 0) {
      ...
      $(".newsDiv").html(
        "There is no Data matching your search result. Please go back and select different search criterias!"
      );
    }
  });
});
...
function getNews(params, cbFunction) {
  var url =
    "https://lmi-news-esdc-edsc-apicast-production.api.canada.ca/clmix-wsx/gcapis/news/data?wildcards=true";
