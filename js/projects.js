...
$(document).ready(function () {
  ...
  for (var key in naics) {
    $('.nacis-select-details').append("<option value=\"".concat(key, "\"> ").concat(naics[key], "</option>"));
  ...
  for (var _key in provinces) {
    $('.pt-select-details').append("<option value=\"".concat(_key, "\">").concat(provinces[_key], "</option>"));
  }
